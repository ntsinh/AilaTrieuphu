package com.example.ntsinh.ailatrieuphu.dataBase;
...
/**
 * Created by ntsinh on 11/13/2016.
 */
...
public class DataBase {
    ...
    public static final String PATH= Environment.getDataDirectory()+
            "/data/com.example.ntsinh.ailatrieuphu/databases/"+DV_NAME;
    ...
    public ArrayList<Question> getData(){
        ...
        for (int i=1;i<16;i++) {
            ...
            String sql="SELECT * FROM "+table+" ORDER BY random() limit 1"; // lấy ra 1 câu hỏi ngẫu nhiên
